...
angular.module('airSqreenApp')
    .controller('DeviceController', function ($rootScope, $scope, $state, $translate, $timeout, api, Principal, KendoUtils, dialogService, AppUtilsService, DATA_STATUS ) {
        ...
        $scope.search = function (item) {
            ...
            $scope.data = KendoUtils.createKendoDataSourceSearch(api.all('admin/devices'), angular.extend(sourceConfig, searchConfig));
        };
