...
public class CampaignDTO {
    ...
    public static Plt161Campaign toEntity(CampaignDTO campaignDTO) {
        ...
        Long[] longArr = new Long[campaignDTO.getDirect_deal_ids().size()];
        longArr = (Long[]) campaignDTO.getDirect_deal_ids().toArray(longArr);
        campaign.setDirect_deal_ids(longArr);

        String[] strArr = new String[campaignDTO.getSupply_types().size()];
        strArr = (String[]) campaignDTO.getSupply_types().toArray(strArr);
        campaign.setSupply_types(strArr);
